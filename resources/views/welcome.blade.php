                ...
                <div class="right-section">
                    ...
                    <input type="hidden" name="_method" value="post" tabindex="-1">
                        <div class="input-group">
                            <input type="text" class="set_value" id="name" name="name" value="{{old('name')}}" placeholder="Name"/>
                            {!! $errors->first('name', '<small class="help-block error-block">:message</small>') !!}
                        </div>
                        <div class="input-group">
                            <input class="set_value" type="email" id="email" name="email" placeholder="Email"/>
                            {!! $errors->first('email', '<small class="help-block error-block">:message</small>') !!}
                        </div>
                        <div class="input-group">
                            <input type="password" class="set_value" id="password" name="password" placeholder="Password" />
                            {!! $errors->first('password', '<small class="help-block error-block">:message</small>') !!}
                        </div>
                        ...
                        <label for="interests">Interests</label></div>
                            ...
                            {!! $errors->first('interest', '<small class="help-block error-block">:message</small>') !!}
                        </div>
